...
//////////////////PENDIENTE: añadir parámetro de organismoId, no valor directo como hago ahora para resolver bug --REVISAR , no va bien aún
async function consultaUltimoBoja(coleccionNombramientos, ObjectId, res) {
  try {
    ...
    // req.ss = numeroPublicados[0].boja; //BORRAR
